...
return new class extends Migration 
{
    ...
    public function up()
    {
        Schema::create('interviews_job_opening_sub_rounds', function (Blueprint $table) {
            $table->uuid('id')->nullable(false)->primary();
            $table->uuid('interviews_job_opening_rounds_id');
            $table->uuid('interviews_sub_rounds_id');
            ...
            $table->tinyInteger('is_question_randomized')->default(1);
    ...
    {
        Schema::dropIfExists('interviews_job_opening_sub_rounds');
    }
};