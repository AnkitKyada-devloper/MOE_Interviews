...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('candidate_interview_sub_rounds', function (Blueprint $table) {
            $table->uuid('id')->nullable(false)->primary();
            $table->uuid('candidate_interview_id');
            $table->uuid('interviews_job_opening_sub_rounds_id');
    ...
    {
        Schema::dropIfExists('candidate_interview_sub_rounds');
    }
};
